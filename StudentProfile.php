...
<div class="p_content">
<div class="left">
  <img class="profile_img" src="<?php echo $row["student_image"] ?>">
</div>
<div class="right">
    <div class="c">
        <div class="p_row">
        <h3 class="prof_info">Name:</h3> <p class="prof_info" ><?php echo $row["s_firstName"]. " ".$row["s_lastName"]?></p> <br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">Email:</h3> <p class="prof_info"><?php echo $row["student_email"] ?></p><br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">phone:</h3> <p class="prof_info"> <?php echo $row["student_phone"] ?></p><br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">password:</h3> <p class="prof_info"> <?php echo $row["student_Password"] ?></p><br>
        </div>
      </div> 
  </div>
</div>

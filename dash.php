...
$query = "SELECT s.s_firstName, s.s_lastName, g.courseID, g.grade
        FROM grade g
        JOIN courses c ON g.courseID = c.course_id
...
<body>
  ...
  <div class="row g-4 justify-content-center">
    <div class="col-sm-6 col-xl-4">
      ...
      <a href="Admin_ViewTeachers.php" class="nav-item nav-link"> <h6 class="mb-0">Teachers</h6></a>
                  
      </div>
    </div>
    <div class="col-sm-6 col-xl-4">
      <div class="bg-light rounded d-flex align-items-center justify-content-center p-5">
      <a href="Students.php" class="nav-item nav-link"> <h6 class="mb-0">Students</h6></a>
    ...
    <div class="col-sm-6 col-xl-4">
      <div class="bg-light rounded d-flex align-items-center justify-content-center p-5">
        ...
        <a href="Cources.php" class="nav-item nav-link"> <h6 class="mb-0">Courses</h6></a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Excellent Students</h6>
                        <a href="">Show All</a>
                    </div>

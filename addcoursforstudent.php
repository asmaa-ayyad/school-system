...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO grade (courseID,grade,studentId)
               VALUES('$course_id','0','$StudentID')";
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <form action=" " method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="inputConfirmPassword" class="col-sm-3 col-form-label text-end fw-bold">course:</label>
                            <div class="col-sm-9">
                             <select class = "form-select form-select-lg mb-3" name="course_id" require>
                                    <?php

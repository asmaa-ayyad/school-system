...
check_auth_with_role("student");
include_once('DB_Connection.php');
if (isset($_SESSION["username"])) {
    $username = $_SESSION["username"];

  
    $queryid = "SELECT id, s_firstName, s_lastName FROM students WHERE student_email = '$username'";
    ...
    $query = "SELECT c.course_number, c.course_name, g.grade,c.course_id
                FROM courses c
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><?php echo $row['s_firstName']. ' ' .$row['s_lastName']?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
   ...
   <!-- Blank Start /////////////////////////////////////////////////////////////////////////////////-->
    ...
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <td><a class="btn btn-sm btn-primary" href="addcoursforstudent.php">Add Course</a></td>
        </div>

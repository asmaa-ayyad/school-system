...
if(preg_match($pattern,$_POST["email"]) && is_numeric($_POST["phone"])){
    ...
    $query_check_email = "SELECT * FROM teachers WHERE teacher_Email = '$email'";
    ...
    $query="INSERT INTO teachers (first_name, second_name ,teacher_Email,teacher_Password ,teacher_phone,teacher_image)
...
?>
  ...
  <div class="row mb-3">
    <label for="inputname3" class="col-sm-3 col-form-label text-end fw-bold" style="width: 20%;">Second Name:</label>
    <div class="col-sm-9">

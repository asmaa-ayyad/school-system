...
$query = "UPDATE grade SET grade = '$grade' WHERE courseID = '$courseId' AND studentId = '$studentId'";
...
?>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <form action=" " method="post">
                        ...
                        <div class="row mb-3">
                            <label for="inputname3" class="col-sm-3 col-form-label text-end fw-bold">Grade:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-lg" id="inputname3" name="grade" require>
                        ...
                        <div class="row mb-3">
                            <label for="inputConfirmPassword" class="col-sm-3 col-form-label text-end fw-bold">Student:</label>
                            <div class="col-sm-9">
                             <select  class = "form-select form-select-lg mb-3" name="student_id" require style="width: 100%; font-size: 16px;">
                                    <option value=""></option>
                                    <?php
                                            $query2 = "SELECT s.id, s.s_firstName, s.s_lastName
                                            FROM students s
                                            INNER JOIN grade g ON s.id = g.studentId
                                            INNER JOIN courses c ON c.course_id = g.courseID
                                            WHERE c.course_id = '$courseId'";


                                    $result2 = mysqli_query($connecction, $query2);
                                    if($result2 && $result2 > 0){
                                        while ($row = mysqli_fetch_assoc($result2)) {
                                            $id = $row['id'];
                                            $student_fname = $row['s_firstName'];
                                            $student_lname = $row['s_lastName'];
                                        
                                            echo "<option value='$id'>$student_fname $student_lname</option>";
                                        }
                                    }

...
$query = "SELECT id, s_firstName ,s_lastName ,student_email ,student_phone FROM students";
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <h6 class="mb-0">Students Table</h6>
                        <!-- <a href="">Show All</a>-->
                        <td><a class="btn btn-sm btn-primary" href="AddStudent.php">Add</a></td>
...
*/
                                        echo '<td>
                                                <a class="btn btn-sm btn-primary" href="EditeStudent.php?id=' . $row["id"] . '">Edite</a>
                                                <a class="btn btn-sm btn-primary" href="StudentProfile.php?id=' . $row["id"] . '">profile</a>

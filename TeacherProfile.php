...
<div class="p_container">
   <div class="card" >
   <h3 class="title"> Teacher-profile</h3>
    <hr class="line">
<div class="p_content">
<div class="left">
  <img class="profile_img" src="<?php echo $row["teacher_image"] ?>">
</div>
<div class="right">
    <div class="c">
        <div class="p_row">
        <h3 class="prof_info">Name:</h3> <p class="prof_info" ><?php echo $row["first_name"]. " ".$row["second_name"]?></p> <br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">Email:</h3> <p class="prof_info"><?php echo $row["teacher_email"] ?></p><br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">phone:</h3> <p class="prof_info"> <?php echo $row["teacher_phone"] ?></p><br>
        </div>
        <div class="p_row">
        <h3 class="prof_info">password:</h3> <p class="prof_info"> <?php echo $row["teacher_password"] ?></p><br>
        </div>
      </div> 
  </div>
</div>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(strlen($_POST["course_name"])==0){
        $nameErr = "*fill field";
    }
    if(strlen($_POST["course_number"])==0){
        $numErr = "*fill field";
    }
    if(strlen($_POST["course_name"])!=0&&strlen($_POST["course_number"])!=0) {
        $courseName = test_input($_POST["course_name"]);
        $courseNumber = test_input($_POST["course_number"]);
        $teacherID = test_input($_POST["teacher_id"]);
    $query = "INSERT INTO courses (course_number, course_name ,teacher_id)
               VALUES('$courseNumber',' $courseName','$teacherID')";
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <form action=" " method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-lg" id="inputname3" name="course_number" require>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-lg" id="inputname3" name="course_name" require>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                             <select class = "form-select form-select-lg mb-3" name="teacher_id" require>
                                    <?php

                                    $query2 = "SELECT teacher_id, first_name,second_name FROM teachers";
                                    $result2 = mysqli_query($connecction, $query2);
                                    while ($row = mysqli_fetch_assoc($result2)) {
                                        $teacher_id = $row['teacher_id'];
                                        $teacher_fname = $row['first_name'];
                                        $teacher_lname = $row['second_name'];
                                        echo "<option value='$teacher_id'>$teacher_fname $teacher_lname</option>";
                                    }

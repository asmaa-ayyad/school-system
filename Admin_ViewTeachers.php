...
$query = "SELECT teacher_id, first_name, second_name ,teacher_Email ,teacher_phone FROM teachers";
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Teachers Table</h6>
                        <!-- <a href="">Show All</a>-->
                        <td><a class="btn btn-sm btn-primary" href="AddTeacher.php">Add</a></td>
...
*/
                                        ...
                                        echo '<td>
                                        <a class="btn btn-sm btn-primary" href="EditeTeacher.php?id='.$row["teacher_id"].'">Edite</a>
                                        <a class="btn btn-sm btn-primary" href="TeacherProfile.php?id='.$row["teacher_id"].'">profile</a>

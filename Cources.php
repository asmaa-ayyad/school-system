...
$query = "SELECT course_id,course_number, course_name FROM courses";
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                       ...
                       <!-- <a href="">Show All</a>-->
                        <td><a class="btn btn-sm btn-primary" href="AddCourse.php">Add</a></td>
...
*/
                           ...
                           echo '<td><a class="btn btn-sm btn-primary" href="EditeCourse.php?id='.$row["course_id"].'">Edite</a></td>';
